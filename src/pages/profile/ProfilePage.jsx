...
const ProfilePage = () => {
  ...
  // Same reason as Navbar — React Query cache persists across
  // refresh cycles via the server. Redux would be null on refresh.
  // Since ProtectedRoute already fetched this, we get it from cache.
  ...
  // WHY show spinner based on isLoading, not !user?
  // isLoading is true only on the FIRST fetch (no cache yet).
  // !user would be true even during refetches, causing unnecessary flicker.
  if (isLoading) {
    return (
